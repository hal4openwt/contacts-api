...
public class SkillsApiController implements SkillsApi {
    ...
    public ResponseEntity<List<Skill>> listSkills() {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<Skill>>(objectMapper.readValue("[ {  \"level\" : \"very good\",  \"name\" : \"name\",  \"id\" : 6,  \"contacts\" : [ null, null ]}, {  \"level\" : \"very good\",  \"name\" : \"name\",  \"id\" : 6,  \"contacts\" : [ null, null ]} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/json", e);
